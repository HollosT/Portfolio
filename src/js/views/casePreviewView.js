...
class CasePreview extends View {
   ...
   async addHandlerToArrow(handler) {
    ...
    animationOpen( btnNumber) {
       ...
       const caseTitle = document.querySelector('.case-title')
            ...
            setTimeout(() => {
                ...
                svgContainer.forEach(svg => svg.style.setProperty('--svgContainerZ', '0'))
            ...
            // arrow.addEventListener('mouseenter', (e) => {
            //     console.log('hello');
            //     arrow.setAttribute("d", "M538.1,336.5c-1.6,10.6-3.1,21.1-4.7,31.7c0.3-0.8,2.4-5.3,7.2-6.6c0.5-0.1,3-0.8,5.4,0 c6,2.1,4.5,11.3,9.6,17.4c7.9,9.6,26.8,6,26.8,5.1c0.1-0.7-15.1,1.2-23.7-8.5c-4.9-5.5-7.8-15-4.2-19.9c1.2-1.7,3.2-2.8,3.8-3.1 c4-2.1,8.1-1.2,9.2-0.8C557.7,346.7,547.9,341.6,538.1,336.5z")
            // });
            // arrow.addEventListener('mouseleave', (e) => {
            //     arrow.setAttribute("d", "M540.6,338.5c-1.2,9.6-2.4,19.1-3.6,28.7c0.7-1.1,2.5-3.5,5.6-4.7c2.1-0.8,4.1-0.8,4.8-0.8 c1.5,0,2.7,0.3,3.7,0.5c3.2,0.7,4,1.5,4.8,1c0.8-0.5,0.4-1.5,1-3.5c0.1-0.4,1-3.5,3.7-5.7c1.4-1.1,2.7-1.5,4.9-2.2 c2.2-0.7,4.1-1,5.4-1.1C561,346.6,550.8,342.5,540.6,338.5z")
            // })
    ...
    animationClose(btnNumber) {
       ...
       const caseTitle = document.querySelector('.case-title')
            ...
            setTimeout(() => {
                ...
                caseContainer.style.backgroundColor = 'var(--light-suplementar)' 
    ...
    generateMarkup() {
        ...
        markup += '</div>'
        // <path id="arrow--${this._data.case_box}" class="arrow hide" data-arrow="${this._data.preview_btn.data_btn}"
        //                 d="M540.6,338.5c-1.2,9.6-2.4,19.1-3.6,28.7c0.7-1.1,2.5-3.5,5.6-4.7c2.1-0.8,4.1-0.8,4.8-0.8 c1.5,0,2.7,0.3,3.7,0.5c3.2,0.7,4,1.5,4.8,1c0.8-0.5,0.4-1.5,1-3.5c0.1-0.4,1-3.5,3.7-5.7c1.4-1.1,2.7-1.5,4.9-2.2 c2.2-0.7,4.1-1,5.4-1.1C561,346.6,550.8,342.5,540.6,338.5z" />
        //             </svg>
